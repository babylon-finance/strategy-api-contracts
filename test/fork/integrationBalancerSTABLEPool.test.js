...
describe.skip('Balancer integration Stable Pool', function () {
  let owner;
  let garden;
  let controller;
  let keeper;
  ...
  before(async () => {
    ...
    USDT = await ethers.getContractAt("@balancer-labs/v2-solidity-utils/contracts/openzeppelin/ERC20.sol:ERC20", "0xdAC17F958D2ee523a2206206994597C13D831ec7");
